...
#
# Nine steps. Each one starts a real tool on this machine and prints the
...
echo "Nine steps. Every number on the slides is produced here, now."
...
clear
print -P "%F{green}All nine steps done. Logs are in PROOF/logs/.%f"
